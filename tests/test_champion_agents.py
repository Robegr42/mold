...
def test_stable_champion_env_config(mock_architect, mock_rag, sample_task):
    os.environ["GENSIE_RAG_K"] = "1"
    os.environ["GENSIE_REASONING_LANG"] = "English"
    os.environ["GENSIE_HINT_COUNT"] = "5"
...
def test_slim_champion_env_config(mock_architect, mock_rag, sample_task):
    os.environ["GENSIE_RAG_K"] = "2"
    os.environ["GENSIE_REASONING_LANG"] = "Spanish"
    os.environ["GENSIE_HINT_COUNT"] = "2"
    ...
    mock_response_1 = MagicMock()
    mock_response_1.choices[0].message.content = "Análisis: Juan."
